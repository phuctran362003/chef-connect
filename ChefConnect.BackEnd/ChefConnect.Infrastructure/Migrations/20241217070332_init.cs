    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChefInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChefInformations_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_ChefInformations_ChefId",
                        column: x => x.ChefId,
                        principalTable: "ChefInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ChefInformations_ChefId",
                        column: x => x.ChefId,
                        principalTable: "ChefInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChefInformations_UserId",
                table: "ChefInformations",
                column: "UserId",
                unique: true);
